...
(function() {
  var Client, Dummy, Status, User, WebSocketServer, action, clients, colors, config, db, dummy, getClientByName, getLobbyNames, lobby, mongoose, sendLobbyUpdate, wss;
    ...
    this.connection = {
      send: function(json) {
        ...
        switch (data.action) {
          ...
          case action.server.youWin:
            return _this.status({
              action: action.client.goToLobby
            });
          case action.server.partnerLeft:
            return _this.status({
              action: action.client.goToLobby
            });
        }
